...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		var foldersToCheck:Array<String> = [Main.path + Paths.getPreloadPath('scripts/')];
		...
		for (folder in foldersToCheck)
		{
			...
			{
				for (file in HSys.readDirectory(Main.path + folder))
				{
		...
		#if LUA_ALLOWED
		var filesPushed:Array<String> = [];
		var foldersToCheck:Array<String> = [Main.path + Paths.getPreloadPath('data/' + Paths.formatToSongPath(SONG.song) + '/')];
